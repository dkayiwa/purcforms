...
public class FormDesignerDragController extends AbstractDragController{
	...
	public void dragEnd() {
				...
				if("move".equals(cursor) || ("".equals(cursor) && 
				   (context.selectedWidgets.size() > 0 && !(((DesignWidgetWrapper)context.selectedWidgets.get(0)).getWrappedWidget() instanceof DesignGroupWidget)))){
					...
					for (Widget widget : context.selectedWidgets) {
						SavedWidgetInfo infoOriginal = savedWidgetInfoMap.get(widget);
						WidgetLocation infoNew = new WidgetLocation(widget, widget.getParent());
						int x = infoOriginal.initialDraggableParentLocation.getLeft() - infoNew.getLeft();
						int y = infoOriginal.initialDraggableParentLocation.getTop() - infoNew.getTop();
		...
		String id = ((DesignWidgetWrapper) context.draggable).getBinding();
		int left = ((DesignWidgetWrapper) context.draggable).getLeftInt();
		int top = ((DesignWidgetWrapper) context.draggable).getTopInt();
		GWT.log("dragEnd: " + id + " left:" + left + " top: " + top + "\n---");
	}
	...
	public void dragMove() {
		...
		int left = ((DesignWidgetWrapper) context.draggable).getLeftInt();
		int top = ((DesignWidgetWrapper) context.draggable).getTopInt();
		GWT.log("dragMove: " + id + " left:" + left + " top: " + top);
	...
	public void dragStart() {
		...
		int left = ((DesignWidgetWrapper) context.draggable).getLeftInt();
		int top = ((DesignWidgetWrapper) context.draggable).getTopInt();
		GWT.log("dragStart: " + id + " left:" + left + " top: " + top);
