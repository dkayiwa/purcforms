...
var __gwtModuleFunction = $wnd.FormDesigner;
var $sendStats = __gwtModuleFunction.__sendStats;
$sendStats('moduleStartup', 'moduleEvalStart');
var $gwt_version = "2.7.0vaadin4";
var $strongName = '';
var $gwt = {};
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.FormDesigner=");
    idx += (13 + "FormDesigner".length);  // 
  }
  if (idx >= 0) {
